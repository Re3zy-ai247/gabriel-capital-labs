...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    monthly: 399, yearly: 3990, blurb: "Run your practice on Kai", status: "live", plan: "agency", group: "agency",
  ...
  },
  {
    ...
    monthly: 699, yearly: 6990, blurb: "For growing teams", status: "soon", group: "agency",
  ...
  },
  {
    ...
    monthly: 1299, yearly: 12990, blurb: "For high-volume operations", status: "soon", group: "agency",
    ...
    features: [
      ...
      "Dedicated onboarding + quarterly strategy reviews",
    ],
    accent: "text-ocean-200", cardClass: "border-ocean-600/30 bg-ink-800/40", buttonClass: "btn-ghost",
  },
  {
    id: "enterprise", name: "Enterprise", kai: "Kai Enterprise", kaiLine: "Kai, deployed to your standard.",
    monthly: null, yearly: null, blurb: "For 100+ clients", status: "contact", group: "agency",
...
const MATRIX: [string, ...string[]][] = [
  ...
  ["Client workspaces", "-", "-", "-", "20", "25", "50", "Unlimited"],
