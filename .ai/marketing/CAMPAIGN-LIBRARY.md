...
- **Status:** BUILT; G-01 legal identity fact resolved in an isolated candidate. Production integration and received-footer verification remain open. CAN-SPAM controls: canonical postal footer + one-click unsubscribe + `List-Unsubscribe` header.
