...
// is what a mount CAN mean: when a live journey is CURRENTLY, cinematically
...
// T2.2 FIX 3: MUST match the "dashboard" row's `id` in
// lib/transition-runtime/roomRegistry.ts — this is Mission Control's own
// journey-room identity, read by the bail predicate below.
const ROOM_ID = "dashboard";
