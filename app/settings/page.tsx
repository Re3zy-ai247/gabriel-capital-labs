      ...
      <div className="max-w-2xl">
        ...
        <div className="mt-8 border-t border-ink-700/70 pt-6">
          ...
          <p className="mb-4 text-sm leading-relaxed text-slate-400">
            ...
            Turn this on to register this device for push alerts. No dispute, bureau-response, or deadline
            alert exists yet, so turning this on won&apos;t notify you about any of those today — it only makes
            your device ready in case that changes. Turn it off any time; nothing else about your account changes.
          </p>
          <PushToggle />
        </div>
