...
// the canonical server-scoped company identity. Fails safe everywhere (a bad
...
// postal footer is sourced from the canonical server-scoped company identity. Skips
