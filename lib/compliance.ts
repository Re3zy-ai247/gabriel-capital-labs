...
// The cxos-lane scrubber rewrite (329-line rule engine) was deliberately EXCLUDED
// from this extraction per Opus merge review C1 — it returns via its own gated
// slice with a compliance-bar test; provenance feat/cxos-phase3 lib/compliance.ts.
