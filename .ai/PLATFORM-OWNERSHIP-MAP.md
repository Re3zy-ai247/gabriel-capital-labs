...
| **Reputation / trust (Vector XP)** | `lib/arena/*` (own-XP, reconcile-on-read); `VECTOR-XP.md`/ADR-0037 (PROPOSED ledger) | PARTIAL | Owns XP/trust math. Identity owns none of it; it may render read-only trust signals on a profile (not built). |
