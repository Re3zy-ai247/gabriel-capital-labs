...
- [ ] **Owner: review the Preview, then approve merge to `main`.** Until then `main`/prod (`creditvector.app`) stays untouched, MAIL_LIVE OFF. (No `.vercel` link needed — Git integration built it.)
