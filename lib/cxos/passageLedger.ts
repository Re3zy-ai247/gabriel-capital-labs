...
export const PASSAGE_LEDGER: PassageLedgerRow[] = [
  ...
  },
  {
    ...
    source: "journey phase (call · clearance); composition only",
    status: "PROTOTYPE",
  ...
  },
  {
    ...
    represents: "the chamber's own life — a breathing standing core, near-imperceptibly rotating rings, drifting motes, slow light shafts, haze and a soft floor reflection",
