...
Status: **Accepted — Founder-authorized 2026-07-31; isolated RC1 and protected Preview only**
Date: 2026-07-31
...
This decision authorizes one candidate commit, one isolated review-branch push, and one protected Preview from the exact isolated commit. It authorizes no merge, production deployment or promotion, production alias change, database action, migration, schema change, auth change, billing change, force-push, or unrelated-room implementation. Preview approval is not production integration approval.
